...
#     ABSTRACT_FROM => q[lib/Tomba/Finder.pm]
#     AUTHOR => [q[Mohamed Ben rebia <b.mohamed@tomba.io>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
...
INST_LIBDIR      = $(INST_LIB)/Tomba
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Tomba
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Tomba-Finder' >> META_new.yml
